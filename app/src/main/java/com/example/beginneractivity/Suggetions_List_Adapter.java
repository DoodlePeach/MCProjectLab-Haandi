...
public class Suggetions_List_Adapter extends BaseAdapter {
    ...
    public Suggetions_List_Adapter(Context a, ArrayList<String>imageViews , ArrayList<String> dishName,ArrayList<String> dishResturant,
